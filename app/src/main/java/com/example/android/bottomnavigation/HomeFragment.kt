...
class HomeFragment : Fragment(),RecyclerViewAdapter.ItemClickListener {
    ...
    override fun onCreateView(
        ...
        val list= listOf<ModelClass>(
            ModelClass("Title1","Description1"),
            ModelClass("Title2","Description2"),
            ModelClass("Title3","Description3"),
            ModelClass("Title4","Description4")
        )
        val adapter=RecyclerViewAdapter(view.context,list,this)
